...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.open("workbench/settings/main/index.jsp", "workareaFrame");
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal"
                        onclick="window.location.href='manager_login.jsp';">确定
                </button>
            </div>
        </div>
    </div>
...
<div id="top" style="height: 70px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 15px; left: 50px; font-size: 24px; font-weight: 400; color: white; font-family: 'times new roman'">
        城理饿了么系统 &nbsp;<span style="font-size: 14px;">&copy;2021&nbsp;钟俊杰</span></div>
...
<div id="center" style="position: absolute;top: 70px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            ...
            <li class="liClass"><a href="workbench/settings/business/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-user"></span>商家管理</a></li>
            <li class="liClass"><a href="workbench/settings/buyer/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-user"></span>买家管理</a></li>
        </ul>
