...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.open("workbench/buyer/main/index.jsp", "workareaFrame");
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal"
                        onclick="window.location.href='buyer_login.jsp';">确定
                </button>
            </div>
        </div>
    </div>
...
<div id="top" style="height: 70px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 15px; left: 50px; font-size: 24px; font-weight: 400; color: white; font-family: 'times new roman'">
        城理饿了么系统 &nbsp;<span style="font-size: 14px;">&copy;买家版</span></div>
            ...
            <li class="dropdown user-dropdown">
                <a href="javascript:void(0)" style="text-decoration: none; color: snow; margin-right: 60px" class="dropdown-toggle"
                   data-toggle="dropdown">
                    ...
                    <span style="font-size: 16px">${user.realName}</span>
...
<div id="center" style="position: absolute;top: 70px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <!-- 导航 -->
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto; background-color: #269abc">

        <ul id="no1" class="nav nav-pills nav-stacked">
            <li class="liClass"><a href="workbench/settings/main/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-home"></span> 工作台</a></li>
            <li class="liClass"><a href="workbench/buyer/shopping/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-leaf"></span> 商品列表</a></li>
            <li class="liClass"><a href="workbench/buyer/cart/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-shopping-cart"></span> 购物车</a></li>
            <li class="liClass"><a href="workbench/buyer/order/index.jsp" target="workareaFrame"><span
                    class="glyphicon glyphicon-usd"></span> 订单</a></li>
        </ul>
