            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        //跳转到工作台的初始页（欢迎页）
                        window.location.href = "workbench/buyer/index.jsp";
...
<div style="position: absolute; top: 30px; left: 0px; width: 100%;">
    <img src="image/login2.jpg" style="width: 100%; height: 90%; position: relative; top: 50px;">
</div>
<div id="top" style="height: 80px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 20px; left: 500px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
        城理饿了么系统 &nbsp;<span style="font-size: 15px;">&copy;买家版</span></div>
</div>

<div style="position: absolute; top: 150px; right: 100px;width:450px;height:400px;border:1px solid #D5D5D5; background-color: #a6e1ec">
